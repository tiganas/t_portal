<link type="text/css" rel="stylesheet" href="/xml-yii/themes/frontend/css/home.single3.css">
          ...
          <div class="list-group">
                <div class="panel panel-default">
                    ...
                    <div id="position1">
                        ...
                        <!--<a target="blank" style="color:#4cae4c;text-align:center;" href="<?php //echo $film->film_deeplink?>" class="list-group-item" ><i class="icon-caret-right"></i> <strong>Film deeplink</strong></a>-->
                </div>
            </div>
        </div>
